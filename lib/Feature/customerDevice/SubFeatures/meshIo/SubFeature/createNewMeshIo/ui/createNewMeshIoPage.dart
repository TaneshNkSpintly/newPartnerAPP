...
TextEditingController _meshIOSerialNoController = TextEditingController();

TextEditingController _meshIONameController = TextEditingController();
...
class CreateNewMeshIOPage extends StatefulWidget {
  String orgId;
  CreateNewMeshIOPage({super.key, required this.orgId});

  @override
  State<CreateNewMeshIOPage> createState() => _CreateNewMeshIOPageState();
}

class _CreateNewMeshIOPageState extends State<CreateNewMeshIOPage> {
  @override
  void initState() {
    ...
    _meshIOSerialNoController.clear();
    _meshIONameController.clear();
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            TextFormField(
                              controller: _meshIONameController,
                              style: TextStyle(
                                color: Colors.black,
                                fontFamily: 'Inter',
                              ),
                              decoration: InputDecoration(
                                labelText: "MeshIo Name",
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      controller: _meshIOSerialNoController,
                                      style: TextStyle(color: Colors.black),
                                      decoration: InputDecoration(
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      ...
                                      if (result != null && result != "0") {
                                        setState(() {
                                          _meshIOSerialNoController.text =
                                              result.toString();
                                        });
                                      }
                                    },
                            ...
                            return GestureDetector(
                              onTap: () async {
                                if (showNextButton) {
                                  ...
                                  setState(() {});
                                  MessageResponse? ResultCreateNewMeshIo =
                                      await ref
                                  ...
                                  print(
                                      "ResultCreateNewMeshIo==type: ${ResultCreateNewMeshIo!.type}");
                                  if (ResultCreateNewMeshIo!.type ==
                                      "success") {
                                    var Title =
                                        "MeshIO Added ${_meshIONameController.text.toString()}";
                                    var SubTitle =
                                        "New meshIo ‘${_meshIOSerialNoController.text.toString()}’ has been successfully added in Site ${_siteController.text} ";
                                    await showSccessBottomSnackBAR(
                                        context, Title, SubTitle);
                                  } else if (ResultCreateNewMeshIo!.type ==
                                      "error") {
                                    String errorMessage = ResultCreateNewMeshIo
                                        .errorMessage!.errorMessage;
                                    var title = "Couldn't add the MeshIo!";
