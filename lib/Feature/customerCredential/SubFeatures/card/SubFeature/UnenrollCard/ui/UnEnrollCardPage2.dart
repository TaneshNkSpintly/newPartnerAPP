...
class UnEnrollCardPage2 extends StatefulWidget {
  UnEnrollCardPage2();

  @override
  State<UnEnrollCardPage2> createState() => _UnEnrollCardPage2State();
}
...
class _UnEnrollCardPage2State extends State<UnEnrollCardPage2> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          'Count : 1 card(s) successfully unenrolled',
          textAlign: TextAlign.center,
          style: TextStyle(
