...
import 'package:partner_app/Feature/customerDevice/SubFeatures/meshIo/SubFeature/meshInfo/ui/bottomSnackbars.dart';
...
import '../../../ui/findWifiPage.dart';

class GatewayIoInfoInfoPage extends StatefulWidget {
  const GatewayIoInfoInfoPage({super.key});

  @override
  State<GatewayIoInfoInfoPage> createState() => _GatewayIoInfoInfoPageState();
}

class _GatewayIoInfoInfoPageState extends State<GatewayIoInfoInfoPage> {
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        GestureDetector(
          onTap: () async {
            var ReplaceDeviceConfirmation =
                await showUpdateSoftwareTypeBottomSnackBAR(context);
          },
          child: Container(
            child: Row(
              children: [
        ...
        GestureDetector(
          onTap: () async {
            var Result = Navigator.push(context,
                MaterialPageRoute(builder: (context) => FindWifiPage()));
          },
          child: Container(
            child: Row(
              children: [
